        ...
        *,
        ...
        if settings.agent_use_real_llm:
            try:
                ...
                return {
                    "result": ensure_generate_result(fallback_result, knowledge_context, prompt),
                    "debug": {
        ...
        fallback_result = self._build_fallback_result(tender_fields, judge_result, knowledge_context)
        return {
            "result": ensure_generate_result(fallback_result, knowledge_context, prompt),
            "debug": {
                "provider": "fallback-template",
